...
public class ERC20Token extends Contract {
    ...
    public static final Event DELEGATEVOTESCHANGED_EVENT = new Event("DelegateVotesChanged", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}, new TypeReference<Uint224>() {}, new TypeReference<Uint224>() {}));
    ;
    ...
    public static final Event TAXHANDLERCHANGED_EVENT = new Event("TaxHandlerChanged", 
    ...
    public static final Event TREASURYHANDLERCHANGED_EVENT = new Event("TreasuryHandlerChanged", 
            Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}, new TypeReference<Address>() {}));
    ;
    ...
    public static List<DelegateChangedEventResponse> getDelegateChangedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse.delegator = (String) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.currentDelegate = (String) eventValues.getNonIndexedValues().get(1).getValue();
            typedResponse.newDelegate = (String) eventValues.getNonIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public static List<DelegateVotesChangedEventResponse> getDelegateVotesChangedEvents(TransactionReceipt transactionReceipt) {
        ...
        for (Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.log = eventValues.getLog();
            typedResponse.delegatee = (String) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.oldVotes = (BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
            typedResponse.newVotes = (BigInteger) eventValues.getNonIndexedValues().get(2).getValue();
            responses.add(typedResponse);
        }
        return responses;
    }
    ...
    public static List<TaxHandlerChangedEventResponse> getTaxHandlerChangedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TAXHANDLERCHANGED_EVENT, transactionReceipt);
        ArrayList<TaxHandlerChangedEventResponse> responses = new ArrayList<TaxHandlerChangedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TaxHandlerChangedEventResponse typedResponse = new TaxHandlerChangedEventResponse();
            typedResponse.log = eventValues.getLog();
    ...
    public Flowable<TaxHandlerChangedEventResponse> taxHandlerChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, TaxHandlerChangedEventResponse>() {
            @Override
            public TaxHandlerChangedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(TAXHANDLERCHANGED_EVENT, log);
                TaxHandlerChangedEventResponse typedResponse = new TaxHandlerChangedEventResponse();
                typedResponse.log = log;
                typedResponse.oldAddress = (String) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.newAddress = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<TaxHandlerChangedEventResponse> taxHandlerChangedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TAXHANDLERCHANGED_EVENT));
        return taxHandlerChangedEventFlowable(filter);
    }
    ...
    public static List<TreasuryHandlerChangedEventResponse> getTreasuryHandlerChangedEvents(TransactionReceipt transactionReceipt) {
        List<Contract.EventValuesWithLog> valueList = staticExtractEventParametersWithLog(TREASURYHANDLERCHANGED_EVENT, transactionReceipt);
        ArrayList<TreasuryHandlerChangedEventResponse> responses = new ArrayList<TreasuryHandlerChangedEventResponse>(valueList.size());
        for (Contract.EventValuesWithLog eventValues : valueList) {
            TreasuryHandlerChangedEventResponse typedResponse = new TreasuryHandlerChangedEventResponse();
            typedResponse.log = eventValues.getLog();
            typedResponse.oldAddress = (String) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.newAddress = (String) eventValues.getNonIndexedValues().get(1).getValue();
            responses.add(typedResponse);
    ...
    public Flowable<TreasuryHandlerChangedEventResponse> treasuryHandlerChangedEventFlowable(EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new Function<Log, TreasuryHandlerChangedEventResponse>() {
            @Override
            public TreasuryHandlerChangedEventResponse apply(Log log) {
                Contract.EventValuesWithLog eventValues = extractEventParametersWithLog(TREASURYHANDLERCHANGED_EVENT, log);
                TreasuryHandlerChangedEventResponse typedResponse = new TreasuryHandlerChangedEventResponse();
                typedResponse.log = log;
                typedResponse.oldAddress = (String) eventValues.getNonIndexedValues().get(0).getValue();
                typedResponse.newAddress = (String) eventValues.getNonIndexedValues().get(1).getValue();
    ...
    public Flowable<TreasuryHandlerChangedEventResponse> treasuryHandlerChangedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        EthFilter filter = new EthFilter(startBlock, endBlock, getContractAddress());
        filter.addSingleTopic(EventEncoder.encode(TREASURYHANDLERCHANGED_EVENT));
        return treasuryHandlerChangedEventFlowable(filter);
    }
    ...
    public RemoteFunctionCall<Tuple2<BigInteger, BigInteger>> checkpoints(String param0, BigInteger param1) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_CHECKPOINTS, 
                ...
                Arrays.<TypeReference<?>>asList(new TypeReference<Uint32>() {}, new TypeReference<Uint224>() {}));
    ...
    public RemoteFunctionCall<String> delegates(String param0) {
    ...
    public RemoteFunctionCall<BigInteger> getVotesAtBlock(String account, BigInteger blockNumber) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_GETVOTESATBLOCK, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, account), 
                new org.web3j.abi.datatypes.generated.Uint32(blockNumber)), 
    ...
    public RemoteFunctionCall<TransactionReceipt> setTaxHandler(String taxHandlerAddress) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETTAXHANDLER, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, taxHandlerAddress)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }

    public RemoteFunctionCall<TransactionReceipt> setTreasuryHandler(String treasuryHandlerAddress) {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(
                FUNC_SETTREASURYHANDLER, 
                Arrays.<Type>asList(new org.web3j.abi.datatypes.Address(160, treasuryHandlerAddress)), 
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<String> taxHandler() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_TAXHANDLER, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
    ...
    public RemoteFunctionCall<String> treasuryHandler() {
        final org.web3j.abi.datatypes.Function function = new org.web3j.abi.datatypes.Function(FUNC_TREASURYHANDLER, 
                Arrays.<Type>asList(), 
                Arrays.<TypeReference<?>>asList(new TypeReference<Address>() {}));
        return executeRemoteCallSingleValueReturn(function, String.class);
    }
